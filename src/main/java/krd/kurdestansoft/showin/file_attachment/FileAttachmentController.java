...
public class FileAttachmentController {
    ...
    @GetMapping("/v1/get-by-place/{plcId}")
    public ResponseEntity<List<FileAttachmentDTO>> findByPlace(@PathVariable Long plcId ){

        List<FileAttachment> fileAttachments=    service.getPlaceById(plcId);
        List<FileAttachmentDTO> fileAttachmentDTOs=mapper.toFileAttachmentDTOs(fileAttachments);
        return ResponseEntity.ok(fileAttachmentDTOs);
    }
